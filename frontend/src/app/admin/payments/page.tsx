  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage student transactions and monitor revenue.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-medium text-muted-foreground text-sm">Total Revenue</h3>
        ...
        <div className="bg-white rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-medium text-muted-foreground text-sm">Successful Payments</h3>
            <div className="w-8 h-8 rounded-full bg-success-light flex items-center justify-center text-success">
        ...
        <div className="bg-white rounded-xl border border-border p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-medium text-muted-foreground text-sm">Failed</h3>
            <div className="w-8 h-8 rounded-full bg-destructive-light flex items-center justify-center text-destructive">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-border overflow-hidden">
        <div className="p-4 border-b border-border flex justify-between items-center bg-muted/50">
          ...
          <select 
            ...
            className="text-sm border-border rounded-lg px-3 py-1.5 focus:ring-indigo-500 focus:border-indigo-500"
          >
                  ...
                  <tr key={payment._id} className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="font-medium text-foreground">{payment.user?.fullName || 'Unknown'}</span>
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border
                        ${payment.status === 'success' ? 'bg-success-light text-success border-green-200' : 
                          payment.status === 'pending' ? 'bg-warning-light text-warning border-amber-200' :
