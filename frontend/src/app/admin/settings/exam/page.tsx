  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="p-8">
      <div className="flex justify-between items-center border-b border-border pb-6 mb-8">
        <div>
          <h2 className="text-xl font-bold text-foreground">Exam Preferences</h2>
          <p className="text-sm text-muted-foreground mt-1">Global defaults for new mock tests.</p>
        </div>
        <button 
          type="submit"
          disabled={isPending}
      ...
      <div className="space-y-8 max-w-3xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-2">Default Duration (mins)</label>
            <input 
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-2">Default Passing %</label>
            <input 
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-muted-foreground mb-2">Default Negative Marking</label>
            <input 
              type="number"
              step="0.1"
        ...
        <div className="border-t border-border pt-8 space-y-4">
          <h3 className="text-sm font-bold text-foreground uppercase tracking-wider mb-4">Exam Experience</h3>
          
          <div className="flex items-center justify-between p-4 bg-muted border border-border rounded-xl">
            <div>
              <h4 className="text-sm font-medium text-foreground">Auto Submit</h4>
              <p className="text-xs text-muted-foreground mt-1">Automatically submit the exam when the timer ends.</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-muted border border-border rounded-xl">
            <div>
              <h4 className="text-sm font-medium text-foreground">Shuffle Questions</h4>
              <p className="text-xs text-muted-foreground mt-1">Randomize the order of questions for each student.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div className="flex items-center justify-between p-4 bg-muted border border-border rounded-xl">
            <div>
              <h4 className="text-sm font-medium text-foreground">Shuffle Options</h4>
              <p className="text-xs text-muted-foreground mt-1">Randomize the order of options within each question.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
