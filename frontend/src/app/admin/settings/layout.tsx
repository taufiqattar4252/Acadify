  ...
  return (
    <div className="max-w-7xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage global configurations and preferences.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
          ...
          <nav className="flex flex-col gap-1 sticky top-24">
            {sidebarLinks.map((link) => {
              ...
              return (
                ...
                >
                  <Icon className={cn('w-4 h-4', isActive ? 'text-primary-600' : 'text-muted-foreground')} />
                  {link.name}
                </Link>
              );
            })}
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white rounded-2xl shadow-sm border border-border min-h-[500px]">
            {children}
          </div>
        </div>
      </div>
