    ...
    <Container className="py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          ...
          <p className="text-gray-600 mb-4">Access hundreds of MHT-CET practice questions across Physics, Chemistry, and Mathematics.</p>
          <Button variant="secondary" className="w-full">View Tests</Button>
        </Card>
        
        <Card>
          <h3 className="text-lg font-semibold mb-2">Performance Analytics</h3>
          <p className="text-gray-600 mb-4">Track your progress and identify areas for improvement with detailed analytics.</p>
